...
const items = [
  ...
  {
    id: 2,
    title: "iPhone 3D Demo Animation",
    img: "./iphone.png",
    desc: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores ab id ad nesciunt quo aut corporis modi? Voluptate, quos sunt dolorum facilis, id eum sequi placeat accusantium saepe eos laborum.",
    demo: "https://warrencodehub.github.io/iphone-react/",
  },
  {
    id: 3,
    title: "EClaims Philhealth Integration System",
    img: "./eclaims.png",
    desc: "Lorem ipsum tet sit amet consectetur adipisicing elit. Dolores ab id ad nesciunt quo aut corporis modi? Voluptate, quos sunt dolorum facilis, id eum sequi placeat accusantium saepe eos laborum.",
    demo: "#",
  },
  {
    id: 4,
      ...
      <div className="container">
        <div className="wrapper">
          ...
          <motion.div className="textContainer" style={{ y }}>
            <h2>{item.title}</h2>
            <p>{item.desc}</p>
            <button onClick={() => openInNewTab(item.demo)}>See Demo</button>
          </motion.div>
        </div>
      </div>
    </section>
